...
void funcion_filosofos( int id )
{
  ...
  while ( true )
  {
    // Para evitar interbloqueo: filósofos pares empiezan por el tenedor izquierdo,
    // filósofos impares empiezan por el tenedor derecho
    if (id_filosofo % 2 == 0) {
    ...
    // Para la liberación da igual el orden, no se va a dar interbloqueo
